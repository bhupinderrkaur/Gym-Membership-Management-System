...
public class removeMember implements ActionListener{
    ...
    removeMember(){
        ...
        l5.setLayout(null);
        ImageIcon img=new ImageIcon(("C:\\Users\\hp\\Documents\\NetBeansProjects\\Gym Membership\\src\\Members\\pictures\\rem.jpg"));
        l5.setIcon(img);
        f.add(l5);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                ...
                String str = "select name,phone,email from member where mem_id ='"+t.getText()+"' ";
        ...
        if(ae.getSource()==b1){
            try{
                connection con = new connection();
                String str = "delete from member where mem_id = '"+t.getText()+"'";
