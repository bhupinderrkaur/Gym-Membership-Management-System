...
public class printData implements ActionListener {
    ...
    String mem_id,name,father,address,phone,email,pt,goals,age,dob,aadhar;
    JButton b1,b2;
    ImageIcon icon;

    printData(String m_id){
        try{
            connection con = new connection();
            String str = "select * from member where mem_id = '"+m_id+"'";
