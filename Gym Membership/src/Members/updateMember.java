 ...
 * @author hp
 */
public class updateMember extends addMember implements ActionListener{
    JFrame f;
    ...
    updateMember(String idaa){
        ...
        id15.setLayout(null);
        ImageIcon img=new ImageIcon(("C:\\Users\\hp\\Documents\\NetBeansProjects\\Gym Membership\\src\\Members\\pictures\\2.jpg"));
        id15.setIcon(img);

        id8 = new JLabel("Update Member Detail:");
    ...
    void showData(String s){
        try{
            ...
            String str = "select * from member where mem_id = '"+s+"'";
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                connection con = new connection();
                String str = "update member set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email='"+t5.getText()+"',pt='"+t6.getText()+"',goals='"+t7.getText()+"',aadhar='"+t8.getText()+"',mem_id='"+t9.getText()+"' where mem_id='"+id_mem+"'";
    ...
    public static void main(String[] arg){
        new updateMember("Update Details");
    }
