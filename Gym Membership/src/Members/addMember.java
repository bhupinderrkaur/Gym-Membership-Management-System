...
public class addMember implements ActionListener {
   ...
   // addMember(int i){}
    ...
    addMember(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(("C:\\Users\\hp\\Documents\\NetBeansProjects\\Gym Membership\\src\\Members\\pictures\\1.jpg"));
        id15.setIcon(img);

        id8 = new JLabel("New Member Details");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                ...
                String q = "insert into member values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"')";
